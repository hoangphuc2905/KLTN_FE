...
const Page = () => {
  const [activeComponent, setActiveComponent] = useState('papers');
      ...
      <div className="border-b bg-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between">
            <Button className="w-[153px] h-[46px] bg-[#00ace8] rounded-lg text-white text-xs font-medium" onClick={() => handleNavigation('papers')}>
              Tra cứu bài báo NCKH
            </Button>
            <Button className="w-[153px] h-[46px] bg-white rounded-lg text-[#7b7777] text-xs font-medium" onClick={() => handleNavigation('authors')}>
              Tra cứu tác giả
            </Button>
            <Button className="w-[153px] h-[46px] bg-white rounded-lg text-[#7b7777] text-xs font-medium" onClick={() => handleNavigation('departments')}>
              Tra cứu theo khoa
            </Button>
            <Button className="w-[153px] h-[46px] bg-white rounded-lg text-[#7b7777] text-xs font-medium" onClick={() => handleNavigation('years')}>
              Tra cứu theo năm
            </Button>
            <Button className="w-[153px] h-[46px] bg-white rounded-lg text-[#7b7777] text-xs font-medium" onClick={() => handleNavigation('groups')}>
              Tra cứu theo nhóm
            </Button>
            <Button className="w-[153px] h-[46px] bg-white rounded-lg text-[#7b7777] text-xs font-medium" onClick={() => handleNavigation('fields')}>
